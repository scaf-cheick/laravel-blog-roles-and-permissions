...
@section('title') Update un role @endsection
            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Update un role</span>
                        <form action="{{route('role.update', $role->id)}}" method="POST">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" id="title" name="title" required="" value="{{ $role->name }}">
                                @if ($errors->has('title'))
                            ...
                            <div class="input-field col s12">
                                ...
                                <select multiple required="" name="permissions[]">
                                    ...
                                    @foreach($permissions as $permission)
                                        <option value="{{$permission->name}}" {{ $role->permissions->contains($permission->id) ? 'selected':'' }} >{{$permission->name}}</option>
                                    @endforeach
                                </select>
